        ...
        <div className="aboutDiv">
            ...
            <div className="aboutDiv__div">
                <p>
                    ...
                    Scikit-learn, TensorFlow, Scratch, Flask, basics of AWS, Bootstrap, jQuery and D3.js (currently not working with them
                    professionally). In this website you can find my projects and certifications as demonstration of my acquired skills.
                </p>
            </div>
        </div>
    )
